...
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
VALUES (nextval('hibernate_sequence'), 'Some Restriction 4', 'Description 4' ,2, '2020-02-02', '2020-02-04', NULL);
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
VALUES (nextval('hibernate_sequence'), 'Some Restriction 5', 'Description 5' ,0, '2021-04-11', '2021-04-14', '2021-12-20');
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
...
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
VALUES (nextval('hibernate_sequence'), 'Some Restriction 10', 'Description 10', 3, '2020-08-04', '2020-08-04', '2021-08-30');
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
VALUES (nextval('hibernate_sequence'), 'Some Restriction 11', 'Description 11', 3, '2021-02-03', '2021-02-04', NULL);
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
VALUES (nextval('hibernate_sequence'), 'Some Restriction 12', 'Description 12', 3, '2021-02-03', '2021-02-04', NULL);
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
VALUES (nextval('hibernate_sequence'), 'Some Restriction 13', 'Description 13', 2, '2021-02-03', '2021-02-04', '2021-06-02');
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
...
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
VALUES (nextval('hibernate_sequence'), 'Some Restriction 17', 'Description 17', 4, '2021-09-14', '2021-09-16', '2021-12-19');
INSERT INTO e_restriction(id, title, description, scope, issued, validSince, expired)
VALUES (nextval('hibernate_sequence'), 'Some Restriction 18', 'Description 18', 4, '2021-10-30', '2021-11-01', NULL);
